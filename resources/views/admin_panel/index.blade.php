...
<body>
            ...
            <div class="flex justify-between">
                <div class="flex space-x-7">
                    ...
                    <div class="items-center hidden space-x-1 md:flex">
                        <a href="/admin_panel"
                            class="px-2 py-4 font-semibold text-blue-500 border-b-4 border-blue-500 ">Products</a>
    ...
    <form id="insertProduct" action="/admin/product/insert" method="POST" enctype="multipart/form-data" class="hidden">
        @csrf
        @method('post')
        <div class="block w-11/12 p-6 mx-auto mt-6 bg-white rounded-lg shadow-lg">
            <h1 class="mb-4 text-xl text-blue-700 uppercase">Insert new product</h1>
            <div class="mb-6 form-group">
                <label for="product_name" class="inline-block mb-2 text-gray-700 form-label">Enter Product Name</label>
                <input type="text"
              ...
              focus:text-gray-700 focus:bg-white focus:border-blue-700 focus:outline-none"
                    id="product_name" placeholder="Product Name" name="name" value="{{ old('name') }}">
                @error('name')
          ...
          <div class="mb-6 form-group">
            <div class="flex">
                <div class="mb-3 xl:w-96">
                  <label for="category" class="inline-block mb-2 text-gray-700 form-label">Select Category</label>
                  <select id="category" name="category" class="form-select appearance-none
                    block
                    w-full
                    px-3
                    py-1.5
                    ...
                    ease-in-out
                    m-0
                    focus:text-gray-700 focus:bg-white focus:border-blue-700 focus:outline-none" aria-label="Default select example" >
            ...
            <div class="mb-6 form-group">
                <label for="product_description" class="inline-block mb-2 text-gray-700 form-label">Enter Product
                    Description</label>
                <textarea
                    class="
              form-control
              ...
              focus:text-gray-700 focus:bg-white focus:border-blue-700 focus:outline-none
            "
                    id="product_description" rows="3" placeholder="Product Description" name="desc"
            ...
            <div class="mb-6 form-group">
                <div class="flex">
                    <div class="mb-3 xl:w-96">
                        <label for="price" class="inline-block mb-2 text-gray-700 form-label">Product's
                            Price</label>
                  ...
                  m-0
                  focus:text-gray-700 focus:bg-white focus:border-blue-700 focus:outline-none"
                            aria-label="Default select example" placeholder="499.00" value="{{ old('price') }}">
                        @error('price')
                            <p class="pt-1 pl-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="overflow-hidden">
                        <table class="min-w-full">
                            <thead class="bg-white border-b">
                                <tr>
                                    <th scope="col"
                                        class="px-6 py-4 font-semibold text-left text-gray-900 text-md">
                                        Name
                                    </th>
                                    <th scope="col"
                                        class="px-6 py-4 font-semibold text-left text-gray-900 text-md">
                                ...
                                @foreach ($products as $product)
                                    <tr
                                        ...
                                        <td class="px-6 py-4 text-gray-900 whitespace-nowrap text-md">
                                            <textarea class="px-6 py-2" name="" id="" cols="20" rows="5" disabled> {{ $product->name }}
                    </textarea>
                                        </td>
                                        <td class="px-6 py-4 text-gray-900 text-md w-80 whitespace-nowrap">
                                            <textarea class="px-6 py-2" name="" id="" cols="20" rows="5" disabled>{{ $product->desc }}
                    </textarea>
                                        </td>
                                        <td class="px-6 py-4 text-gray-900 text-md whitespace-nowrap">
                                            <img style="height:25vh; max-width:fit-content;"
                                        ...
                                        <td class="px-6 py-4 text-gray-900 text-md whitespace-nowrap">
                                            <form action="/product/update" method="post">
                                                ...
                                                <div class="flex justify-center space-x-2">
                                                    <button
                                                        class="inline-block px-6 py-2.5 bg-blue-600 text-white text-xs leading-tight uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">Edit</button>
                                                </div>
                                            </form>
                                        </td>
                                        <td class="px-6 py-4 text-gray-900 text-md whitespace-nowrap">
