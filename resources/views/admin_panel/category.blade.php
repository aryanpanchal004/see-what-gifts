...
<body>
                ...
                <div class="flex space-x-7">
                    ...
                    <div class="items-center hidden space-x-1 md:flex">
                        ...
                        <a href="/admin_panel/categories"
                            class="px-2 py-4 font-semibold text-blue-500 border-b-4 border-blue-500">Category</a>
    ...
    <form id="insertProduct" action="/admin/category/insert" method="POST" enctype="multipart/form-data"
        class="hidden">
        @csrf
        @method('post')
        <div class="block w-11/12 p-6 mx-auto mt-6 bg-white rounded-lg shadow-lg">
            <h1 class="mb-4 text-xl text-blue-700 uppercase">Insert new category</h1>
            <div class="mb-6 form-group">
                <label for="product_name" class="inline-block mb-2 text-gray-700 form-label">Enter Category Name</label>
                <input type="text"
              ...
              focus:text-gray-700 focus:bg-white focus:border-blue-700 focus:outline-none"
                    id="product_name" placeholder="Enter category name here" name="name" value="{{ old('name') }}">
                @error('name')
            ...
            <div class="flex mb-6 form-group">
                <div class="flex justify-center">
                    <div class="mb-3">
                        <label for="formFile" class="inline-block mb-2 text-gray-700 form-label">Select Category
                            Image</label>
                        <input
                            class="form-control
                  block
              ...
              <tbody>
                      @foreach ($categories as $category)
                        <tr class="transition duration-300 ease-in-out bg-white border-b hover:bg-gray-100">
                            ...
                            <td class="px-6 py-4 text-gray-900 whitespace-nowrap text-md">
                                <img class="mt-4" src="{{ asset('storage/' . $category->image) }}"
                                    alt="{{ $category->image }}" style="height:40vh;margin:auto;">
                            </td>
