...
<head>
    ...
    <title>All Returns | Admin Panel</title>
    <style>
        h2 {
            text-align: center;
            padding: 20px 0;
...
<body>
                ...
                <div class="flex space-x-7">
                    ...
                    <div class="items-center hidden space-x-1 md:flex">
                        ...
                        <a href="/admin_panel/returns"
                            class="px-2 py-4 font-semibold text-blue-500 border-b-4 border-blue-500">Returns</a>
                        <a href="/admin_logout"
    ...
    @if (count($returns) != 0)
        <h2 class="text-3xl text-blue-600">Return Products History</h2>
    ...
    @else
        <div class="flex items-center justify-center w-full h-full gap-10 bg-white">
            ...
            <div class="flex flex-col gap-3">
                <p class="self-center text-3xl">No Returns found!</p>
            </div>
        </div>
    @endif
